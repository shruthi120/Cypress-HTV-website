describe("Testing H-Family TV tab", () => {
    ...
    it('Checking H-Family Widget Card 1 is clickable', () => {
        cy.get('.carousel-lg > .carousel-inner > .active > :nth-child(1) > .aspect-ratio-box > .img-wrpr > .card-img-top', { timeout: 10000 }).click({force: true})
             cy.url();
    })
...
cy.get('#vhl-1 > .carousel-inner > .carousel-item > :nth-child('+i+') > .card-body > .card-primary-text').should('exist').invoke('text').then((urlText) => {
  ...
  it('Checking H-Family Widget Card 2 is clickable', () => {
    ...
    cy.get('.carousel-lg > .carousel-inner > .active > :nth-child(2) > .aspect-ratio-box > .img-wrpr > .card-img-top', { timeout: 10000 }).click({force: true})
         cy.url();
})
