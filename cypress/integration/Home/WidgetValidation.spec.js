describe("Testing Home tab", () => {
    ...
    it('Checking Widgets Titles are visible', () => {
     ...
     it('Checking H-Family firt 4 Widgets Cards size', () => {
        cy.visit('https://testhtvfun.ventunotech.com/', { timeout: 10000 })
        const tem=[];
         for(var i=1;i<5;i++){
        cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > :nth-child('+i+') > .aspect-ratio-box > .img-wrpr > .card-img-top', { timeout: 10000 }).invoke('attr', 'src').then((urlText) => {
            const temp = urlText.toString();
            cy.log(temp)
             tem.push(temp);
            })
     ...
     it('Checking H-Family TV -first 4 Video titles are visible', () => {
        const tem=[];
        for(var i=1;i<5;i++){
         cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > :nth-child('+i+') > .card-body > .card-primary-text > .video-name > a', { timeout: 10000 }).invoke('text').then((urlText) => {
             const temp = urlText.toString();
             cy.log(temp);
             tem.push(temp);
            })
     ...
     it('Checking H-Family first 4 videos are clickable', () => {
        const tem=[];
        for(var i=1;i<5;i++){
        cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > :nth-child('+i+') > .aspect-ratio-box > .img-wrpr > .card-img-top', { timeout: 10000 }).click({ force: true })
        cy.url()
        cy.location('href').then((urlText) => {
            const temp = urlText
            cy.log(temp);
     ...
     it('Checking H-Family TV - first 4 Videos  - Play btns are visible', () => {
        cy.visit('https://testhtvfun.ventunotech.com/', { timeout: 10000 })
         for(var i=1;i<5;i++){
         cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > :nth-child(1) > .aspect-ratio-box > .video-play-icon > .play', { timeout: 10000 }).should('exist');
         }
     })
     it('Checking Widget Card indicator - H-Family icon nxt & previous are visible', () => {
         ...
         cy.get(':nth-child(4) > .carousel-lg > .carousel-control-prev', { timeout: 10000 }).should('exist');
     })
     ...
     it('Checking H-Family TV - Video title 5 is visible', () => {
         cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > .v-card > .card-body > .card-primary-text > .video-name > a', { timeout: 10000 }).invoke('text').then((urlText) => {
             const temp = urlText.toString();
             cy.log(temp);
             cy.request({
                 method: "POST",
     ...
     it('Checking H-Family Video 5 is clickable', () => {
        cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > .v-card > .aspect-ratio-box > .img-wrpr > .card-img-top', { timeout: 10000 }).click({ force: true })
        cy.url()
        cy.location('href').then((urlText) => {
            const temp = urlText
            cy.log(temp);
     ...
     it('Checking H-Family TV - Video 5 - Play btn is visible', () => {
        cy.visit('https://testhtvfun.ventunotech.com/', { timeout: 10000 })
         cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .active > .v-card > .aspect-ratio-box > .video-play-icon > .play', { timeout: 10000 }).should('exist');
     })
     ...
     it('Checking Podcast Widgets Cards size', () => {
        const tem=[];
        for(var i=1;i<5;i++){
        cy.get(':nth-child(10) > .carousel-lg > .carousel-inner > .active > :nth-child('+i+') > .aspect-ratio-box > .img-wrpr > .card-img-top', { timeout: 10000 }).invoke('attr', 'src').then((urlText) => {
            const temp = urlText.toString();
            cy.log(temp);
            tem.push(temp);
        })
    ...
    it('Checking Podcast - Video titles are visible', () => {
     ...
     it('Checking Podcast - Videos - Play btns are visible', () => {
        cy.visit('https://testhtvfun.ventunotech.com/') 
         for(var i=1;i<5;i++){
         cy.get(':nth-child(10) > .carousel-lg > .carousel-inner > .active > :nth-child('+i+') > .aspect-ratio-box > .video-play-icon > .play', { timeout: 10000 }).should('exist');
         }
     })
    ...
    it('Checking H-Family next card is visible', () => {
        cy.get(':nth-child(4) > .carousel-lg > .carousel-inner > .carousel-item-next > .v-card > .card-body', { timeout: 20000 }).should('exist');
    })
    //Music & Beyond
    it('Checking Widget Card indicator - Music & Beyond icon nxt & previous are visible', () => {
        cy.visit('https://testhtvfun.ventunotech.com/')
